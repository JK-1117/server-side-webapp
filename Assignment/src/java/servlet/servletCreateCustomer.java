 ...
 * @author User
 */
public class servletCreateCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet servletCreateCustomer</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet servletCreateCustomer at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        sessionbeanCustomer.addCustomer(Integer.parseInt(cusNumber), companyname, contactfname, contactlname, phoneNum, addr1, addr2, city, state, postcode, country, salesno, bd);
